                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group has-feedback">
                            ...
                            <span class="glyphicon form-control-feedback" style="padding-top:6px"
                    ...
                    <div class="input-group">
						<span class="input-group-addon"><i
                                class="fa fa-user-circle-o"></i></span> <input type="text"
                                                                               ...
                                                                               data-error="Ne hagyd üresen" required>
                    </div>
                ...
                <div class="form-group has-feedback">
                    <div class="input-group">
                        ...
                        <input type="text" name="phone" id="phone"
                               ...
                               data-error="Érvényes telefonszámot adj meg" required>
                    </div>
                    <span class="glyphicon form-control-feedback" style="padding-top:6px" aria-hidden="true"></span>
                    <div class="help-block with-errors"></div>
                </div>
                    ...
                    <div class="col-xs-4 col-sm-3 col-md-3">
							<span class="button-checkbox">
								<button type="button" class="btn" data-color="info"> Elfogadom
                                                     ...
                                                     data-error="El kell fogadnod a feltételeket" required
